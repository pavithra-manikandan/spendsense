...
function ChartTooltipContent({
  ...
  React.ComponentProps<"div"> & {
    ...
    indicator?: "line" | "dot" | "dashed"; nameKey?: string; labelKey?: string
  }) {
                  ...
                  {itemConfig?.icon ? <itemConfig.icon /> : (
                    !hideIndicator && (
                      <div
                        ...
                        style={{ "--color-bg": indicatorColor, "--color-border": indicatorColor, backgroundColor: indicatorColor, borderColor: indicatorColor } as React.CSSProperties}
                      />
                    )
                  )}
